        ...
        try {
            ...
            if (msg == null || msg.length() == 0) {
                ...
                if (findFornecedor(id) == null) {
                    throw new NonexistentEntityException("O fornecedor com id " + id + " não existe mais.");
                }
            }
            throw ex;
        } finally {
    ...
    public void destroy(Long id) throws NonexistentEntityException {
        ...
        try {
            ...
            try {
                ...
                throw new NonexistentEntityException("O fornecedor com id " + id + " não existe mais.", enfe);
            }
